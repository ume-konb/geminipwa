...
### ■ 注意事項
- 本フォークは **私用目的** のため、**サポートは行いません**。
- 公開・編集にあたって **告知などは行いません**。
- 本コードは **ブラウザ上での使用を前提** としており、**ローカル環境は考慮されていません**。
- フォーク元コードの製作者様を除き、**ご質問・ご意見・ご要望には対応いたしません**。
- 本コードの使用によって損害・影響が発生した場合、**公開者は一切の責任を負いません**。
- **コードのフォーク・他コードへの流用などは、フォーク元の基準に準じてください。**
