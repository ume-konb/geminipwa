...
### ■ 注意事項
-  ※本フォークは私用目的のため、性質上、サポートは行われません。当コードの公開・編集にあたって予告・告知などは行いません。
-  当コードはブラウザ上での使用を前提としており、ローカル環境での使用は考慮されておりません。
-  フォーク元コードの製作者様を除き、ご質問・ご意見・ご要望は承りません。 また、当コードによって損害や影響が生じた場合においても、公開陣は一切の責任を負いません。
